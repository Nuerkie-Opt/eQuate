  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(children: <Widget>[
          ...
          SizedBox(height: 10.0),
          Text(
            'The theorem attributed to Pythagoras is that the square on the hypotenuse of a right-angled triangle is equal in area to the sum of the squares on the other two sides',
            style: TextStyle(
              fontFamily: 'OpenSans',
              fontSize: 20.0,
            ),
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Image.asset(
              'assets/images/pythagoraseg.png',
            ),
          ),
          TextButton(
              onPressed: () {
